...
- We can use NDVI or temperature or Population density index to apply city clustering algorithm (ISODATA algorithm), then generate a cluster map. Based on this, we can know what category a sample point has been classified into, and return back to map. We can determine the boundaries of the city
...
Cluster c: bare earth
  ...
  <img src="images/cluster_example.png" height="300px"/>
  Cluster_example
