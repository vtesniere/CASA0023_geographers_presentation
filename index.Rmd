...
```{r echo=FALSE, out.width='90%', fig.align='center', fig.cap= "New residential quarters (built after 1990); 2. New residential areas; 3. City boundaries; 4. Boundaries of the current administrative sectors"}
...
.pull-left[```{r echo=FALSE, out.height=400, out.width=600, fig.align='left'}
